# TradeSysX <img src="docs/examples/tradesysx-icon.svg" alt="TradeSysX logo" align="left" width="80">
...
- `<outdir>/images/` — system-level plots (trades distribution, balance, Monte Carlo, MAE-vs-R scatter, portfolio composition)
